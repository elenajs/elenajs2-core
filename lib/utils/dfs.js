...
for (var functionName in fs) {
    var functionCode = fs[functionName];
    if (functionName && functionCode) {
        if (typeof functionCode === 'function' && !/(^[_A-Z]|^create|^(un)?watch|Sync$)/.test(functionName)) {
            // It is something we want to convert
...
module.exports = dfs;
//# sourceMappingURL=../utils/dfs.js.map